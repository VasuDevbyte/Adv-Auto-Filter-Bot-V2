    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_message(
                chat_id = update.chat.id,
                text=f"Hey There, We Found This📡... /n Requested By ;- {update.from_user.mention} 😎 /n ● Searched For :- <code>{query}</code> 🔎 /n ● Total Results ;- {(len_results)} 💯 /n 🌴 Powered By :- @Explore_Cinema ⚜",
